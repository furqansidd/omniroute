...
if [ ! -e "$ROOT_DIR/docs/plans/task.md" ]; then
  pass "Runtime tracking file absent (clean state): docs/plans/task.md"
else
  pass "Runtime tracking file present (active task state): docs/plans/task.md"
fi
